...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `Ты эксперт по созданию концепций музыкальных проектов. Создай детальную и креативную концепцию для музыкального проекта.
...
- concept: подробная концепция и история проекта
- genre: основной жанр
- mood: настроение проекта
- target_audience: целевая аудитория
- suggested_tracks: массив названий треков или тем (для альбома 8-12, для EP 4-6, для сингла 1-2)
- marketing_angle: маркетинговый подход для продвижения
