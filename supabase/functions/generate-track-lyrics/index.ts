...
Строго соблюдай формат SUNO.AI тегов и верни ТОЛЬКО JSON без пояснений.

СТРУКТУРА JSON:
{
  "lyrics": "Полный текст песни в одном строковом поле с тегами [Intro]/[Verse]/[Chorus]/[Bridge]/[Outro], с разметкой {main_vox}/{backing_vox}/{harmonies} и эффектами [!fade_in]/[!build_up]/[!drop]/[!reverb]",
  "structure": ["intro","verse","chorus","verse","chorus","bridge","chorus","outro"],
  "mood": "Краткое, но точное описание настроения",
  "themes": ["тема1","тема2","тема3"],
  "suno_tags": ["BPM: 140","Genre: Hip-Hop","Mood: Energetic","Language: Russian"]
}
