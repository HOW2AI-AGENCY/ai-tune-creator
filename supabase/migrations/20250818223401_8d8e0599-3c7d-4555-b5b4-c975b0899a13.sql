-- Fix log_critical_operation fallback join to resolve "column p.user_id does not exist"
...
BEGIN
    ...
    -- Fallback 2: infer user from projects via artists
    IF current_user_id IS NULL AND entity_type = 'track' THEN
        SELECT a.user_id INTO current_user_id
